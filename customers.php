...
<body class="">
						...
						<tbody>
							...
							while($row	=	sqlsrv_fetch_array($query,SQLSRV_FETCH_ASSOC))
							{
								...
								<tr>
									...
									<td><?php echo $row['Customers_FullName']; ?></td>
									<td><?php echo $row['Customers_type']; ?></td>
									<td><?php echo $row['Customers_lvl']; ?></td>
									<td><?php echo $row['Customers_status']; ?></td>
									<td><?php echo $row['Customers_remark']; ?></td>
								...
								<div class="modal fade" id="modal_customer_edit_<?php echo $row['Customers_ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											<form action="process/customer_edit.php?customer_id=<?php echo $row['Customers_ID']; ?>" method="POST">
	...
	<div class="modal fade" id="modal_customer_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<form action="process/customer_add.php" method="POST">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12 padding-b-15">
								<label>Customers_Code</label>
								<input class="form-control" name="Customers_Code" readonly value="<?php echo getnewcuscode(); ?>">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Customers_FullName</label>
								<input class="form-control" name="Customers_FullName">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Customers_type</label>
							...
							<div class="col-md-12 padding-b-15">
								<label>Customers_datestart</label>
								<input class="form-control" type="date" name="Customers_datestart_<?php echo $row['Customers_ID']; ?>" value="<?php echo $row['Customers_datestart']; ?>">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Customers_lvl</label>
								<input class="form-control" name="Customers_lvl">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Customers_remark</label>
								<input class="form-control" name="Customers_remark">
							</div>
						</div>
					</div>
					<div class="modal-footer">
