...
<body class="">
						...
						<div class="panel-body">
							<div class="row">
								...
								while($row_room_list	=	sqlsrv_fetch_array($query_room_list,SQLSRV_FETCH_ASSOC))
								{
									...
									?>
									<div class="col-md-3">
										<div style="cursor: pointer;" data-toggle="modal" data-target="#room_<?php echo $row_room_list['Rooms_ID']; ?>">
											<?php echo $border; ?>
												<div class="panel-heading">
										...
										<div class="modal fade" id="room_<?php echo $row_room_list['Rooms_ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
											<div class="modal-dialog modal-sm" role="document">
												<div class="modal-content">
													<form action="../process/room_update.php?room_id=<?php echo $row_room_list['Rooms_ID']; ?>" method="POST">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
															<h4 class="modal-title" id="myModalLabel">Update Status <?php echo '['.$row_room_list['Rooms_Code'].'] '; ?></h4>
														</div>
														<div class="modal-body">
															<div class="row">
																<div class="col-md-12 padding-b-15">
																	<label>Update Startus</label>
																	<select class="form-control input-lg" name="updatestartus">
	...
	<div class="modal fade" id="modal_room_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<form action="../process/room_add.php" method="POST">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12 padding-b-15">
								...
								<select class="form-control" name="Building_Code">
									<option selected disabled>== select ==</option>
									<?php
									$sql4		=	"
													SELECT	*
													FROM	[dbo].[Building]
													";
									$query4		=	sqlsrv_query($connect,$sql4) or die( 'SQL Error = '.$sql4.'<hr><pre>'. print_r( sqlsrv_errors(), true) . '</pre>');
									while($row4	=	sqlsrv_fetch_array($query4,SQLSRV_FETCH_ASSOC))
									{
										?>
										<option value="<?php echo $row4['Building_Code']; ?>"><?php echo $row4['Building_Name']; ?></option>
										<?
									}
									?>
								</select>
							...
							<div class="col-md-12 padding-b-15">
								<label>Rooms Code</label>
								<input class="form-control" name="Rooms_Code">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Rooms Name</label>
								<input class="form-control" name="Rooms_Name">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Rooms Option</label>
								<input class="form-control" name="Rooms_Option">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Rooms Price</label>
								<input class="form-control" name="Rooms_Price">
							</div>
						</div>
					</div>
					<div class="modal-footer">
