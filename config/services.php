...
<body class="">
					...
					<table id="example" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							while($row	=	sqlsrv_fetch_array($query,SQLSRV_FETCH_ASSOC))
							{
								?>
								<tr>
									<td><?php echo $row['Servicess_Code']; ?></td>
									<td><?php echo $row['Servicess_Type']; ?></td>
									<td><?php echo $row['Servicess_Name']; ?></td>
									<td><?php echo $row['Servicess_Unit']; ?></td>
									<td><?php echo $row['Servicess_Price']; ?></td>
									<td><?php echo $row['Servicess_Remark']; ?></td>
	...
	<div class="modal fade" id="modal_asset_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<form action="../process/servicess_add.php" method="POST">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12 padding-b-15">
								<label>Servicess_Code</label>
								<input class="form-control" name="Servicess_Code">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Servicess_Type</label>
								<input class="form-control" name="Servicess_Type">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Servicess_Name</label>
								<input class="form-control" name="Servicess_Name">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Servicess_Unit</label>
								<input class="form-control" name="Servicess_Unit">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Servicess_Price</label>
								<input class="form-control" name="Servicess_Price">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Servicess_Remark</label>
								<input class="form-control" name="Servicess_Remark">
							</div>
						</div>
					</div>
					<div class="modal-footer">
