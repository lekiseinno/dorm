...
<body class="">
				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-md-6 text-right">
							<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal_utility_add">Add new</button>
						</div>
					</div>
				</div>
					...
					<table id="example" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							while($row	=	sqlsrv_fetch_array($query,SQLSRV_FETCH_ASSOC))
							{
								?>
								<tr>
									<td><?php echo $row['Utilitys_Code']; ?></td>
									<td><?php echo $row['Utilitys_Name']; ?></td>
									<td><?php echo $row['Utilitys_Unit']; ?></td>
									<td><?php echo $row['Utilitys_Price']; ?></td>
									<td><?php echo $row['Utilitys_Status']; ?></td>
									<td><?php echo $row['Utilitys_Remark']; ?></td>
									<td><?php echo getdatetime($row['datecreate']); ?></td>
									<td><?php echo getdatetime($row['lastupdate']); ?></td>
									<td>
										<div class="row">
											<div class="col-md-12 text-center">
												<a class="btn btn-warning btn-xs" href="#" data-toggle="modal" data-target="#modal_customer_edit_<?php echo $row['Customers_ID']; ?>">
								...
								<div class="modal fade" id="modal_customer_edit_<?php echo $row['Customers_ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											<form action="process/asset_edit.php?asset_id=<?php echo $row['Assets_ID']; ?>" method="POST">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
													<h4 class="modal-title" id="myModalLabel">Edit Customer : <b><?php echo $row['Customers_Code']; ?></b></h4>
												</div>
												<div class="modal-body">
													<div class="row">
														<div class="col-md-12 padding-b-15">
															<label>Customers_Code</label>
															<input class="form-control" name="Customers_Code_<?php echo $row['Customers_ID']; ?>" readonly value="<?php echo $row['Customers_Code']; ?>">
														</div>
														<div class="col-md-12 padding-b-15">
															<label>Customers_FullName</label>
															<input class="form-control" name="Customers_FullName_<?php echo $row['Customers_ID']; ?>" value="<?php echo $row['Customers_FullName']; ?>">
														</div>
														<div class="col-md-12 padding-b-15">
															<label>Customers_type</label>
															<select class="form-control" name="Customers_type_<?php echo $row['Customers_ID']; ?>">
														...
														<div class="col-md-12 padding-b-15">
															<label>Customers_datestart</label>
															<input class="form-control" name="Customers_datestart_<?php echo $row['Customers_ID']; ?>" value="<?php echo $row['Customers_datestart']; ?>">
														</div>
														<div class="col-md-12 padding-b-15">
															<label>Customers_lvl</label>
															<input class="form-control" name="Customers_lvl_<?php echo $row['Customers_ID']; ?>" value="<?php echo $row['Customers_lvl']; ?>">
														</div>
														<div class="col-md-12 padding-b-15">
															<label>Customers_remark</label>
															<input class="form-control" name="Customers_remark_<?php echo $row['Customers_ID']; ?>" value="<?php echo $row['Customers_remark']; ?>">
														</div>
														<div class="col-md-12 padding-b-15">
															<label>Customers_Status</label>
															<div class="smart-form">
																<label class="toggle">
																	<input type="hidden" name="Customers_status_<?php echo $row['Customers_ID']; ?>" value="OFF" >
																	<input type="checkbox" name="Customers_status_<?php echo $row['Customers_ID']; ?>"  value='ON' checked="checked">
	...
	<div class="modal fade" id="modal_utility_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<form action="../process/utility_add.php" method="POST">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12 padding-b-15">
								<label>Utilitys_Code</label>
								<input class="form-control" name="Utilitys_Code">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Utilitys_Name</label>
								<input class="form-control" name="Utilitys_Name">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Utilitys_Unit</label>
								<input class="form-control" name="Utilitys_Unit">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Utilitys_Price</label>
								<input class="form-control" name="Utilitys_Price">
							</div>
							<div class="col-md-12 padding-b-15">
								<label>Utilitys_Remark</label>
								<input class="form-control" name="Utilitys_Remark">
							</div>
						</div>
					</div>
					<div class="modal-footer">
