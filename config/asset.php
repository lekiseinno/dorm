					...
					<table id="example" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							while($row	=	sqlsrv_fetch_array($query,SQLSRV_FETCH_ASSOC))
							{
								?>
								<tr>
									<td><?php echo $row['Assets_Code']; ?></td>
									<td><?php echo $row['Assets_Type']; ?></td>
									<td><?php echo $row['Assets_Name']; ?></td>
									<td><?php echo $row['Assets_Where']; ?></td>
									<td><?php echo $row['Assets_Status']; ?></td>
									<td><?php echo $row['Assets_Remark']; ?></td>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-md-6 text-right">
									<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal_room_add">Add new</button>
								</div>
							</div>
						</div>
						<div class="panel-body">
							<div class="row">
								...
								while($row_room_list	=	sqlsrv_fetch_array($query_room_list,SQLSRV_FETCH_ASSOC))
								{
									...
									<div class="col-md-2">
										<?php echo $border; ?>
											<div class="panel-heading">
												# <?php echo '['.$row_room_list['Rooms_Code'].'] ' . $row_room_list['Rooms_Name'] ?>
											</div>
											<div class="panel-body">
